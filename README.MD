...
- Connect to your BierBot using SSH (type `ssh pi@192.168.2.42` in your favorite Terminal, with the IP being the IP of your BierBot).
- Change into the BierBot folder `cd cd /home/pi/BierBot`
- Pull the newest version from GitHub `git pull` (depending on your install, you might get permission errors, run `sudo git pull`)
